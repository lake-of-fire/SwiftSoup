...
CASES = ['empty','empty-html','empty-outer','single-short','single-html','single-outer','single-long','text-8','text-256','text-long','text-raw','text-blank','text-mixed','html-128','outer-128','parse-text','parse-control']
